...
For this homework, please continue using the Kali Linux VM from class. 
...
- To encrypt your message, run:
  ...
  - `openssl enc -nosalt -aes-256-cbc -in dirty_little_secret.txt -out dirty_little_secret.enc -base64 -K 5F4DCC3B5AA765D61D8327DEB882CF992B95990A9151374ABD8FF8C5A7A0FE08 -iv B7B4372CDFBCB3D16A2631B59B509E94`
...
- Now, you can send `symmetrickey.dat`, `symmetrickey.enc`, `iv.dat`, and `dirty_little_secret.enc` to your partner.
